...
(async () => {
  try {
    ...
    defineAssociations();
    //Valable sur pour la phase de dev
    //Creer un user par default
    /*  const generatedHash = await generatePassword("1234");
    await User.bulkCreate([
      { password: generatedHash, email: 'user@myhot.com',role: "admin" },
    ]); */
    //Fin( a supprimer avant mise en prod)
...
const corsOptions = {
  ...
  origin: ["https://localhost:3000/","http://localhost:3000/","http://localhost:3001", "http://localhost:3002","http://myhotdashboard.lanfiasave.com","https://myhot-myhot.vercel.app","https://myhotdashboard.lanfiasave.com","http://myhotdashboard.lanfiasave.com"],
  credentials: true,
